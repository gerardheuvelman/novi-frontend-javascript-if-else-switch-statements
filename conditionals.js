...
// ==========================================
const tenGreateaerThanTwenty = 10>20;
console.log("Is 10 groter dan 20?", tenGreateaerThanTwenty);
...
// ==========================================
const tenIsNotEleven = 10!=11;
console.log("Is 10 niet 11?", tenIsNotEleven);


// ==========================================
// 3. Declareer een variabele en sla daar in op of de woorden 'zoet' en 'sappig' hetzelfde zijn                // geeft false wanneer gelogd
// ==========================================
const zoetIsSappig = "zoet" === "sappig";
console.log("Is zoet sappig??", zoetIsSappig);
...
if (rapportCijfer >8) console.log("Cum Laude!");
